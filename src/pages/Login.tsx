      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mx-auto w-full max-w-6xl">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <section className="editorial-panel p-6 md:p-8 flex flex-col">
            ...
            <p className="editorial-chip mb-5 w-fit">A calmer way to plan your health day</p>
            <h1 className="editorial-heading text-5xl md:text-6xl mb-5">
              Welcome back to your daily wellness rhythm.
            </h1>
            <p className="editorial-subtext text-base md:text-lg max-w-xl mb-8">
              Sign in to review your weather-aware recommendations, calendar-aligned routines, and supportive daily insights.
            </p>
          ...
          <section className="editorial-panel p-6 md:p-8 lg:p-10">
            <h2 className="editorial-heading text-4xl mb-2">Sign in</h2>
            <p className="editorial-subtext mb-6">Choose how you want to continue.</p>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 border-border/70 bg-background/70"
                    required
                  />
                </div>
              </div>
              ...
              <Button type="submit" className="w-full editorial-button" disabled={loading}>
            ...
            <div className="mt-6 rounded-xl border border-border/70 bg-secondary/40 p-3 text-sm editorial-subtext flex items-start gap-2">
              ...
              <p>We use secure authentication and support privacy-first health guidance.</p>
            </div>
