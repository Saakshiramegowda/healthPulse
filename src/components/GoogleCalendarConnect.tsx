...
export function GoogleCalendarConnect({ onSessionUpdated }: GoogleCalendarConnectProps) {
  ...
  if (hasToken === null) {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-border/60 bg-card/40 px-3 py-2 text-sm text-muted-foreground">
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border/60 bg-card/50 px-4 py-3">
      ...
      <Button type="button" size="sm" onClick={handleConnect} disabled={busy} className="gap-2 shrink-0">
